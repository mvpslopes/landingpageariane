...
import { CheckCircle2, AlertCircle, XCircle, TrendingUp, Award, MessageSquare, ArrowRight, ArrowLeft, Play, Clock, CheckCircle } from 'lucide-react';
...
export default function Diagnostic() {
  ...
  const startDiagnostic = () => {
    // Resetar para garantir que começe do zero
    setCurrentStep(0);
    setAnswers({});
    setSelectedAnswer(null);
    setShowResult(false);
    setIsTransitioning(false);
    // Mudar showIntro por último para garantir renderização
    setShowIntro(false);
