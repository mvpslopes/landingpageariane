...
export default function Planning() {
  return (
    <section id="planejamento" className="py-24 bg-gradient-to-br from-brand-brown via-brand-dark-brown to-black text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="flex-shrink-0">
              <div className="w-32 h-32 bg-white/10 border border-white/30 backdrop-blur-md rounded-full flex items-center justify-center shadow-2xl">
                <Target className="w-16 h-16 text-brand-beige" strokeWidth={1.5} />
              </div>
            </div>
            ...
            <div className="flex-1">
              ...
              <div className="w-20 h-[2px] bg-gradient-to-r from-brand-olive to-transparent mb-5" />
