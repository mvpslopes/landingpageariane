...
import { LogOut, FileText, Calendar, User, TrendingUp, AlertCircle, CheckCircle, Download } from 'lucide-react';
...
export default function Dashboard() {
  ...
  // Atualizar relatórios quando a página é carregada
  useEffect(() => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-brand-beige via-brand-off-white to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-col sm:flex-row gap-4">
          <button
            onClick={() => navigate('/sistema/registro')}
